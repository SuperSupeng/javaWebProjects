...
<body>
<s:form id="userAction_save_do" name="Form1" action="addUser" namespace="/user" enctype="multipart/form-data">
	&nbsp;
	<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">
				<s:radio name="sex" id="sex男" list="#{'male':'男','female':'女'}" value="{'male'}"></s:radio>
			</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">
				学历：
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">
				<s:textfield name="telephone" value="" id="telephone"></s:textfield>
			</td>
		</tr>
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff" colSpan="3">
				<s:file name="upload" size="30" value="" id="userAction_save_do_upload" ></s:file>
			</td>
		</tr>
		<TR>
